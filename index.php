...
<html lang="es.SV">
    <head>
        <litle>INICIO DE SECIÓN: JONATHAN ALEXANDER FUENTES FLORES</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-5 ml-4 mr-4 justify-content-center align-self-center">
                <h1>Diseñando Estrategias para la Recuperación y Migración de Base de Datos (RBKG)</h1>
                <form name="fm_iniciar_sesion" id="fm_iniciar_sesion" action="core/process.php" method="post">
